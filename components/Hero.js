...
const Hero = () => {
  return (
    <section className='h-[100vh] flex items-center py-32 lg:py-0 overflow-hidden relative'>
      <div className='lg:absolute z-10 px-24 container w-full sm:w-auto lg:bottom-[17rem] lg:right-[22rem] flex flex-col gap-2 text-secondary text-center md:text-left'>
      ...
      <div
        className='fixed w-full lg:w-[800px] h-[70vh] rounded-lg bottom-20 right-0 bg-cover bg-center bg-no-repeat opacity-50 lg:opacity-80'
        style={{
