const History = () => {
  return (
    <div className='mx-auto container relative mt-[5rem] md:mt-0'>
      <div className='text-primary flex flex-col gap-5 w-[85%] mb-44'>
        <h3 className='text-3xl sm:text-4xl md:text-5xl leading-10 md:leading-[3.5rem] font-bold z-10'>
      ...
      <div
        className='hidden md:block absolute opacity-90 w-2/5 min-h-[24rem] bottom-[10px] lg:bottom-[-70px] rounded-md right-[-90px] bg-cover bg-no-repeat bg-right'
        style={{
